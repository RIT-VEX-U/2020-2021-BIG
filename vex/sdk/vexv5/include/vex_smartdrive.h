...
namespace vex {
  ...
  class smartdrive : public drivetrain  {
    public:  
      ...
      smartdrive( motor_group &l, motor_group &r, vex::inertial &g, double wheelTravel=320, double trackWidth=320, double wheelBase=130, distanceUnits unit=distanceUnits::mm, double externalGearRatio = 1.0 );
      smartdrive( vex::motor &l, vex::motor &r, vex::inertial &g, double wheelTravel=320, double trackWidth=320, double wheelBase=130, distanceUnits unit=distanceUnits::mm, double externalGearRatio = 1.0 );
